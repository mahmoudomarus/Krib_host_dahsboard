...
class Settings(BaseSettings):
    ...
    # Supabase
    supabase_url: str = os.getenv("SUPABASE_URL", "https://bpomacnqaqzgeuahhlka.supabase.co")
    ...
    webhook_secret_key: str = os.getenv("WEBHOOK_SECRET_KEY") or secrets.token_urlsafe(32)
    ...
    def validate_production_config(self):
        ...
        if not self.debug:
            ...
            if missing:
                raise ValueError(f"Production requires these environment variables: {', '.join(missing)}")
