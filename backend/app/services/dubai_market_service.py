...
class DubaiMarketService:
            ...
            "2024-01": [
                {
                    ...
                    "type": DubaiEvent.SHOPPING_FESTIVAL.value,
                    "days": list(range(1, 29)),
                }
            ],
            "2024-03": [
                {
                    "name": "Formula 1 UAE Grand Prix",
                    "type": DubaiEvent.F1_GRAND_PRIX.value,
                    "days": [8, 9, 10],
                }
            ],
            "2024-03": [
                {
                    "name": "Ramadan",
                    "type": DubaiEvent.RAMADAN.value,
                    "days": list(range(10, 32)),
                }
            ],
            "2024-04": [
                {
                ...
                {
                    "name": "Eid Al-Fitr",
                    "type": DubaiEvent.EID_AL_FITR.value,
                    "days": [10, 11, 12],
                },
            ],
            "2024-06": [
                {
                    "name": "Eid Al-Adha",
                    "type": DubaiEvent.EID_AL_ADHA.value,
                    "days": [16, 17, 18],
                }
            ],
            "2024-10": [
            ...
            "2024-12": [
                {
                    ...
                    "type": DubaiEvent.UAE_NATIONAL_DAY.value,
                    "days": [2, 3],
                },
                {
                    "name": "New Year Celebrations",
                    "type": DubaiEvent.NEW_YEAR.value,
                    "days": [31],
                },
            ],
        }
    ...
    def calculate_optimal_price(
        ...
        return {
            ...
            "demand_level": self._get_demand_level(
                seasonal_multiplier, max_event_multiplier
            ),
    ...
    def _get_pricing_recommendations(
        ...
        if season == DubaiSeason.PEAK_WINTER:
            recommendations.append(
                "Peak winter season - maximize revenue with premium rates"
            )
            ...
            calendar.append(
                {
                    ...
                    "active_events": [
                        e["name"]
                        for e in pricing_data["pricing_factors"]["active_events"]
                    ],
        ...
        return {
            ...
            "insights": {
                ...
                "average_confidence": round(
                    sum(f["confidence"] for f in forecast_data) / len(forecast_data), 1
                ),
            },
        }

    def get_market_benchmarks(
        self, area: str, property_type: str = "apartment"
    ) -> Dict[str, Any]:
        ...
        benchmarks = {
            ...
            "area_insights": {
                ...
                "tier": (
                    "Premium"
                    if area_mult >= 1.4
                    else "Standard" if area_mult >= 1.0 else "Budget"
                ),
