...
class S3StorageService:
    def __init__(self):
        ...
        if (
            ...
            logger.warning(
                "S3 configuration incomplete. S3 service disabled. Required: S3_BUCKET_NAME, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY"
            )
            self.s3_client = None
            return
    ...
    async def upload_multiple_images(
        self, files: List[Dict[str, Any]], user_id: str, property_id: str
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def delete_property_image(self, s3_key: str, user_id: str) -> Dict[str, Any]:
        """
